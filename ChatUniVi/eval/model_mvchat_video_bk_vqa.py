...
class long_video_slover():
    ...
    def capture_video_single(self, video_path, cur_frame, half_range, total_frame, video_length):
        decord.bridge.set_bridge("torch")
        ratio_frame = cur_frame / total_frame
        ratio_range = half_range / total_frame
        
        time_frame = video_length * ratio_frame
        time_range = video_length * ratio_range
        
        start_time = time_frame - time_range if time_frame - time_range > 0 else 0
        end_time = time_frame + time_range if time_frame + time_range < video_length else video_length
    ...
    def get_video_features(self, video_path, question, cur_frame, total_frame):
        ...
        return video_fragment.to(self.device), 1
            ...
            with open(file_path, 'r') as json_file:
                ...
                if count > 0:
                    ...
                    for id, qa_key in enumerate(movie_data["breakpoint"]):
                        ...
                        prompt = video_token + '\n' + "Please describe the video in less than 30 words."
